...
writematrix(feat4spin_hierarchy, 'Z:\TBraiC\JF\HCTSA feature gradients\CamCan\Code2Publish\DATA\feat4spin_hierarchy.csv')
...
% save all features for spin test
feat4spin_hierarchy = [statavl_z_mean; delta_z_mean; theta_z_mean; alpha_z_mean; beta_z_mean; gamma_z_mean; fooof_z_mean; peakfreq_z_mean];
writematrix(feat4spin_hierarchy, 'Z:\TBraiC\JF\HCTSA feature gradients\CamCan\Code2Publish\DATA\feat4spin_thickness.csv')
...
writematrix(thickness_mean,'Z:\TBraiC\JF\HCTSA feature gradients\CamCan\Code2Publish\DATA\thickness_mean4spin.csv')
